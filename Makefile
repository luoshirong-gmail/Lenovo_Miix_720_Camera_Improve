...
CC      = gcc
CFLAGS  = -D_GNU_SOURCE -O2 -Wall $(shell pkg-config --cflags gstreamer-1.0 gstreamer-video-1.0 gstreamer-app-1.0)
LDLIBS  = $(shell pkg-config --libs gstreamer-1.0 gstreamer-video-1.0 gstreamer-app-1.0) -lpthread
